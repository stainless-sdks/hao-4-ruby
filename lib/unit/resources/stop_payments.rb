...
module Unit
  module Resources
    class StopPayments
      ...
      #
      #   @option params [Unit::Models::StopPaymentListParams::Filter, nil] :filter
      #
      #   @option params [Unit::Models::StopPaymentListParams::Page, nil] :page Parameters for paginated list requests
      #
