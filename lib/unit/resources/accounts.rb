...
module Unit
  module Resources
    class Accounts
      ...
      #
      # @param params [Unit::Models::AccountCreateParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      def create(params)
        parsed, options = Unit::Models::AccountCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "accounts",
          headers: {
      ...
      #
      # @param params [Unit::Models::AccountRetrieveParams, Hash{Symbol=>Object}] .
      #
      ...
      def retrieve(account_id, params = {})
        parsed, options = Unit::Models::AccountRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
      ...
      #
      # @param params [Unit::Models::AccountUpdateParams, Hash{Symbol=>Object}] .
      #
      ...
      def update(account_id, params)
        parsed, options = Unit::Models::AccountUpdateParams.dump_request(params)
        @client.request(
          method: :patch,
          path: ["accounts/%0s", account_id],
      ...
      #
      # @param params [Unit::Models::AccountListParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      def list(params = {})
        parsed, options = Unit::Models::AccountListParams.dump_request(params)
        @client.request(
          method: :get,
          path: "accounts",
          query: parsed,
      ...
      #
      # @param params [Unit::Models::AccountActivateDacaParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Unit::RequestOptions, Hash{Symbol=>Object}] :request_options
      #
      # @return [Unit::Models::AccountActivateDacaResponse]
      #
      def activate_daca(account_id, params = {})
        @client.request(
          method: :post,
      ...
      #
      # @param params [Unit::Models::AccountCloseParams, Hash{Symbol=>Object}] .
      #
      ...
      def close(account_id, params = {})
        parsed, options = Unit::Models::AccountCloseParams.dump_request(params)
        @client.request(
          method: :post,
      ...
      # @param account_id [String] ID of the account
      #
      # @param params [Unit::Models::AccountDeactivateDacaParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Unit::RequestOptions, Hash{Symbol=>Object}] :request_options
      #
      # @return [Unit::Models::AccountDeactivateDacaResponse]
      #
      def deactivate_daca(account_id, params = {})
        @client.request(
          method: :post,
      ...
      # @param account_id [String] ID of the account
      #
      # @param params [Unit::Models::AccountEnterDacaParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Unit::RequestOptions, Hash{Symbol=>Object}] :request_options
      #
      # @return [Unit::Models::AccountEnterDacaResponse]
      #
      def enter_daca(account_id, params = {})
        @client.request(
          method: :post,
      ...
      #
      # @param params [Unit::Models::AccountFreezeParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      def freeze_(account_id, params = {})
        parsed, options = Unit::Models::AccountFreezeParams.dump_request(params)
        @client.request(
          method: :post,
      ...
      # @param account_id [String] ID of the account to close
      #
      # @param params [Unit::Models::AccountReopenParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Unit::RequestOptions, Hash{Symbol=>Object}] :request_options
      #
      # @return [Unit::Models::AccountReopenResponse]
      #
      def reopen(account_id, params = {})
        @client.request(
          method: :post,
      ...
      # @param account_id [String] ID of the account to get
      #
      # @param params [Unit::Models::AccountUnfreezeParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Unit::RequestOptions, Hash{Symbol=>Object}] :request_options
      #
      # @return [Unit::Models::AccountUnfreezeResponse]
      #
      def unfreeze(account_id, params = {})
        @client.request(
          method: :post,
