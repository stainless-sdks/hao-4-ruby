...
module Unit
  module Resources
    class Disputes
      ...
      #
      #   @option params [Unit::Models::DisputeListParams::Filter, nil] :filter
      #
      #   @option params [Unit::Models::DisputeListParams::Page, nil] :page Parameters for paginated list requests
      #
      # @param opts [Hash{Symbol => Object}, Unit::RequestOptions] Options to specify HTTP behaviour for this request.
      #
