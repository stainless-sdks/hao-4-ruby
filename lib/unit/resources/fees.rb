...
module Unit
  module Resources
    class Fees
      ...
      #
      # @param params [Hash{Symbol => Object}, Unit::Models::FeeCreateParams] Attributes to send in this request.
      #
      ...
      #
      # @param params [Hash{Symbol => Object}, Unit::Models::FeeReverseParams] Attributes to send in this request.
      #
