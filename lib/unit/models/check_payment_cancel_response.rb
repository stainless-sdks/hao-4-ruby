...
module Unit
  module Models
    # @example
    # ```ruby
    # check_payment_cancel_response => {
    #   data: Unit::Models::CheckPaymentCancelResponse::Data
    # }
    # ```
    class CheckPaymentCancelResponse < Unit::BaseModel
      ...
      # data => {
      #   id: String,
      #   attributes: Unit::Models::CheckPaymentCancelResponse::Data::Attributes,
      #   relationships: Unit::Models::CheckPaymentCancelResponse::Data::Relationships,
      #   type: enum: Unit::Models::CheckPaymentCancelResponse::Data::Type
      # }
      # ```
      class Data < Unit::BaseModel
        ...
        #   status: enum: Unit::Models::CheckPaymentCancelResponse::Data::Attributes::Status,
        #   updated_at: Time,
        #   **_
        # }
        # ```
        class Attributes < Unit::BaseModel
          ...
          optional :pending_review_reasons,
                   -> {
                     Unit::ArrayOf[enum: Unit::Models::CheckPaymentCancelResponse::Data::Attributes::PendingReviewReason]
                   },
          ...
          #   # @param counterparty [Unit::Models::CheckPaymentCancelResponse::Data::Attributes::Counterparty]
          ...
          # ```ruby
          # counterparty => {
          #   address: Unit::Models::CheckPaymentCancelResponse::Data::Attributes::Counterparty::Address,
        ...
        # ```ruby
        # relationships => {
        #   account: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Account,
        #   customer: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customer,
        #   customers: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customers,
        #   transaction: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Transaction
        # }
        # ```
        class Relationships < Unit::BaseModel
          ...
          #   # @param customer [Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customer]
          #   # @param customers [Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customers]
          #   # @param transaction [Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Transaction]
          #   #
          ...
          # ```ruby
          # account => {
          #   data: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Account::Data
          # }
          # ```
          class Account < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: enum: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Account::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
          ...
          # ```ruby
          # customer => {
          #   data: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customer::Data
          # }
          # ```
          class Customer < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: enum: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customer::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
          ...
          # ```ruby
          # customers => {
          #   data: -> { Unit::ArrayOf[Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customers::Data] === _1 }
          # }
          # ```
          class Customers < Unit::BaseModel
            ...
            required :data,
                     -> {
                       Unit::ArrayOf[Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Customers::Data]
                     }
          ...
          # ```ruby
          # transaction => {
          #   data: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Transaction::Data
          # }
          # ```
          class Transaction < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: enum: Unit::Models::CheckPaymentCancelResponse::Data::Relationships::Transaction::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
