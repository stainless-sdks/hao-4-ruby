...
module Unit
  module Models
    # @example
    # ```ruby
    # check_payment_list_response => {
    #   data: -> { Unit::ArrayOf[Unit::Models::CheckPaymentListResponse::Data] === _1 }
    # }
    # ```
    class CheckPaymentListResponse < Unit::BaseModel
      ...
      class Data < Unit::BaseModel
        ...
        class Attributes < Unit::BaseModel
          ...
          #
          #   @return [Symbol, Unit::Models::CheckPaymentListResponse::Data::Attributes::AdditionalVerificationStatus, nil]
          ...
          #
          #   @return [Unit::Models::CheckPaymentListResponse::Data::Attributes::Counterparty, nil]
          ...
          #
          #   @return [Symbol, Unit::Models::CheckPaymentListResponse::Data::Attributes::DeliveryStatus, nil]
          ...
          optional :pending_review_reasons,
                   -> {
                     Unit::ArrayOf[enum: Unit::Models::CheckPaymentListResponse::Data::Attributes::PendingReviewReason]
                   },
          ...
          #
          #   @return [Symbol, Unit::Models::CheckPaymentListResponse::Data::Attributes::ReturnReason, nil]
          ...
          # ```ruby
          # counterparty => {
          #   address: Unit::Models::CheckPaymentListResponse::Data::Attributes::Counterparty::Address,
          ...
          class Counterparty < Unit::BaseModel
            # @!attribute [r] address
            #
            #   @return [Unit::Models::CheckPaymentListResponse::Data::Attributes::Counterparty::Address, nil]
            optional :address,
                     -> {
        ...
        # ```ruby
        # relationships => {
        #   account: Unit::Models::CheckPaymentListResponse::Data::Relationships::Account,
        #   customer: Unit::Models::CheckPaymentListResponse::Data::Relationships::Customer,
        #   customers: Unit::Models::CheckPaymentListResponse::Data::Relationships::Customers,
        #   transaction: Unit::Models::CheckPaymentListResponse::Data::Relationships::Transaction
        # }
        # ```
        class Relationships < Unit::BaseModel
          ...
          #
          #   @return [Unit::Models::CheckPaymentListResponse::Data::Relationships::Customer, nil]
          ...
          #
          #   @return [Unit::Models::CheckPaymentListResponse::Data::Relationships::Customers, nil]
          ...
          #
          #   @return [Unit::Models::CheckPaymentListResponse::Data::Relationships::Transaction, nil]
          ...
          # ```ruby
          # account => {
          #   data: Unit::Models::CheckPaymentListResponse::Data::Relationships::Account::Data
          # }
          # ```
          ...
          # ```ruby
          # customer => {
          #   data: Unit::Models::CheckPaymentListResponse::Data::Relationships::Customer::Data
          # }
          # ```
          ...
          # ```ruby
          # customers => {
          #   data: -> { Unit::ArrayOf[Unit::Models::CheckPaymentListResponse::Data::Relationships::Customers::Data] === _1 }
          # }
          # ```
          class Customers < Unit::BaseModel
            ...
            required :data,
                     -> {
                       Unit::ArrayOf[Unit::Models::CheckPaymentListResponse::Data::Relationships::Customers::Data]
                     }
          ...
          # ```ruby
          # transaction => {
          #   data: Unit::Models::CheckPaymentListResponse::Data::Relationships::Transaction::Data
          # }
          # ```
