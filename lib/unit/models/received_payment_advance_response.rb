...
module Unit
  module Models
    ...
    class ReceivedPaymentAdvanceResponse < Unit::BaseModel
      # @!attribute [r] data
      #
      #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data, nil]
      ...
      # @!parse
      #   # @param data [Unit::Models::ReceivedPaymentAdvanceResponse::Data]
      #   #
      ...
      # data => {
      #   id: String,
      #   attributes: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Attributes,
      #   relationships: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships,
      #   type: enum: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Type
      # }
      # ```
      class Data < Unit::BaseModel
        ...
        #
        #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Attributes, nil]
        ...
        #
        #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships, nil]
        ...
        # @!attribute [r] type
        #
        #   @return [Symbol, Unit::Models::ReceivedPaymentAdvanceResponse::Data::Type, nil]
        ...
        # @!parse
        #   # @param id [String]
        #   # @param attributes [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Attributes]
        #   # @param relationships [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships]
        #   # @param type [String]
        #   #
        ...
        #   customer: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::Customer,
        #   payment_advance_transaction: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::PaymentAdvanceTransaction,
        #   receive_payment_transaction: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::ReceivePaymentTransaction,
        #   repay_payment_advance_transaction: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::RepayPaymentAdvanceTransaction
        # }
        # ```
        class Relationships < Unit::BaseModel
          ...
          #
          #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::PaymentAdvanceTransaction, nil]
          ...
          #
          #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::ReceivePaymentTransaction, nil]
          ...
          #
          #   @return [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::RepayPaymentAdvanceTransaction, nil]
          ...
          #   # @param payment_advance_transaction [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::PaymentAdvanceTransaction]
          #   # @param receive_payment_transaction [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::ReceivePaymentTransaction]
          #   # @param repay_payment_advance_transaction [Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::RepayPaymentAdvanceTransaction]
          #   #
          #   def initialize(
          #     account:,
          #     customer:,
          ...
          class Account < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: enum: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::Account::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
          ...
          class Customer < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: enum: Unit::Models::ReceivedPaymentAdvanceResponse::Data::Relationships::Customer::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
