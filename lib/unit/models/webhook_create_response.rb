...
module Unit
  module Models
    ...
    class WebhookCreateResponse < Unit::BaseModel
      ...
      #   type: enum: Unit::Models::WebhookCreateResponse::Data::Type
      # }
      # ```
      class Data < Unit::BaseModel
        ...
        # attributes => {
        #   token: String,
        #   content_type: enum: Unit::Models::WebhookCreateResponse::Data::Attributes::ContentType,
        #   created_at: Time,
        #   delivery_mode: enum: Unit::Models::WebhookCreateResponse::Data::Attributes::DeliveryMode,
        #   label: String,
        #   **_
        # }
        # ```
