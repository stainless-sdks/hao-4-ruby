...
module Unit
  module Models
    class CheckDepositRetrieveResponse < Unit::BaseModel
      ...
      # @!parse
      #   # @param data [Unit::Models::CheckDepositRetrieveResponse::Data, nil]
      #   #
      ...
      class Data < Unit::BaseModel
        ...
        class Attributes < Unit::BaseModel
          ...
          optional :status_history,
                   Unit::ArrayOf[-> {
                     Unit::Models::CheckDepositRetrieveResponse::Data::Attributes::StatusHistory
                   }],
          ...
          #   # @param counterparty [Unit::Models::CheckDepositRetrieveResponse::Data::Attributes::Counterparty, nil]
          #   # @param reason [String, nil]
          #   # @param reason_text [String, nil]
          #   # @param settlement_date [String, nil]
          #   # @param status_created_at [String, nil]
          #   # @param status_history [Array<Unit::Models::CheckDepositRetrieveResponse::Data::Attributes::StatusHistory>, nil]
        ...
        class Relationships < Unit::BaseModel
          ...
          #   # @param customer [Unit::Models::CheckDepositRetrieveResponse::Data::Relationships::Customer, nil]
          #   # @param org [Unit::Models::CheckDepositRetrieveResponse::Data::Relationships::Org, nil]
          #   # @param transaction [Unit::Models::CheckDepositRetrieveResponse::Data::Relationships::Transaction, nil]
          #   #
