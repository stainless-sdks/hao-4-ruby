...
module Unit
  module Models
    # @example
    # ```ruby
    # check_deposit_list_response => {
    #   data: -> { Unit::ArrayOf[Unit::Models::CheckDepositListResponse::Data] === _1 }
    # }
    # ```
      ...
      class Data < Unit::BaseModel
        ...
        class Attributes < Unit::BaseModel
          ...
          optional :status_history,
                   -> {
                     Unit::ArrayOf[Unit::Models::CheckDepositListResponse::Data::Attributes::StatusHistory]
                   },
          ...
          # ```ruby
          # status_history => {
          #   status: Unit::Models::CheckDepositListResponse::Data::Attributes::StatusHistory::Status,
          #   updated_at: String,
          #   updated_by: String
          # }
          # ```
        ...
        # ```ruby
        # relationships => {
        #   account: Unit::Models::CheckDepositListResponse::Data::Relationships::Account,
        #   customer: Unit::Models::CheckDepositListResponse::Data::Relationships::Customer,
        #   org: Unit::Models::CheckDepositListResponse::Data::Relationships::Org,
        #   transaction: Unit::Models::CheckDepositListResponse::Data::Relationships::Transaction
        # }
        # ```
        class Relationships < Unit::BaseModel
          ...
          # ```ruby
          # account => {
          #   data: Unit::Models::CheckDepositListResponse::Data::Relationships::Account::Data
          # }
          # ```
          ...
          # ```ruby
          # customer => {
          #   data: Unit::Models::CheckDepositListResponse::Data::Relationships::Customer::Data
          # }
          # ```
          ...
          # ```ruby
          # org => {
          #   data: Unit::Models::CheckDepositListResponse::Data::Relationships::Org::Data
          # }
          # ```
          ...
          # ```ruby
          # transaction => {
          #   data: Unit::Models::CheckDepositListResponse::Data::Relationships::Transaction::Data
          # }
          # ```
