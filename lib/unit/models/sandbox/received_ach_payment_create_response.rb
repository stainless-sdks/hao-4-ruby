  ...
  module Models
    module Sandbox
      class ReceivedACHPaymentCreateResponse < Unit::BaseModel
        ...
        # @!parse
        #   # @param data [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data, nil]
        #   #
        ...
        class Data < Unit::BaseModel
          ...
          # @!parse
          #   # @param id [String, nil]
          #   # @param attributes [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data::Attributes, nil]
          #   # @param relationships [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data::Relationships, nil]
          ...
          class Relationships < Unit::BaseModel
            ...
            #   # @param payment_advance_transaction [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data::Relationships::PaymentAdvanceTransaction, nil]
            #   # @param receive_payment_transaction [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data::Relationships::ReceivePaymentTransaction, nil]
            #   # @param repay_payment_advance_transaction [Unit::Models::Sandbox::ReceivedACHPaymentCreateResponse::Data::Relationships::RepayPaymentAdvanceTransaction, nil]
            #   #
            #   def initialize(
            #     account:,
            #     customer:,
