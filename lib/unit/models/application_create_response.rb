...
module Unit
  module Models
    class ApplicationCreateResponse < Unit::BaseModel
      ...
      #   # @param included [Array<Unit::Models::ApplicationCreateResponse::Included>, nil]
      #   #
      ...
      class Included < Unit::BaseModel
        ...
        class Attributes < Unit::BaseModel
          ...
          # @!parse
          #   # @param status [String]
          #   # @param address [Unit::Models::ApplicationCreateResponse::Included::Attributes::Address, nil]
