...
module Unit
  module Models
    ...
    class ApplicationCreateResponse < Unit::BaseModel
      ...
      #   # @param included [Array<Unit::Models::ApplicationCreateResponse::Included>]
      #   #
      ...
      class Included < Unit::BaseModel
        ...
        #
        #   @return [Unit::Models::ApplicationCreateResponse::Included::Attributes]
        required :attributes, -> { Unit::Models::ApplicationCreateResponse::Included::Attributes }

        # @!attribute type
        #
        #   @return [Symbol, Unit::Models::ApplicationCreateResponse::Included::Type]
        required :type, enum: -> { Unit::Models::ApplicationCreateResponse::Included::Type }

        # @!parse
        #   # @param id [String]
        #   # @param attributes [Unit::Models::ApplicationCreateResponse::Included::Attributes]
        #   # @param type [String]
        #   #
        ...
        class Attributes < Unit::BaseModel
          ...
          # @!attribute [r] address
          #
          #   @return [Unit::Models::ApplicationCreateResponse::Included::Attributes::Address, nil]
          optional :address, -> { Unit::Models::ApplicationCreateResponse::Included::Attributes::Address }

          # @!parse
          #   # @return [Unit::Models::ApplicationCreateResponse::Included::Attributes::Address]
          #   attr_writer :address
          ...
          # @!parse
          #   # @param status [String]
          #   # @param address [Unit::Models::ApplicationCreateResponse::Included::Attributes::Address]
