...
module Unit
  module Models
    class CheckDepositListParams < Unit::BaseModel
      ...
      # @!parse
      #   # @param filter [Unit::Models::CheckDepositListParams::Filter, nil]
      #   #
      #   # @param include [String, nil]
      #   #
      #   # @param page [Unit::Models::CheckDepositListParams::Page, nil] Parameters for paginated list requests
      #   #
