...
module Unit
  module Models
    module Applications
      ...
      #   data: Unit::Models::Applications::DocumentCreateResponse::Data
      # }
      # ```
      class DocumentCreateResponse < Unit::BaseModel
        # @!attribute [r] data
        #
        #   @return [Unit::Models::Applications::DocumentCreateResponse::Data, nil]
        ...
        # @!parse
        #   # @param data [Unit::Models::Applications::DocumentCreateResponse::Data]
        #   #
        ...
        class Data < Unit::BaseModel
          ...
          # attributes => {
          #   status: String,
          #   address: Unit::Models::Applications::DocumentCreateResponse::Data::Attributes::Address,
          ...
          class Attributes < Unit::BaseModel
            ...
            # @!attribute [r] address
            #
            #   @return [Unit::Models::Applications::DocumentCreateResponse::Data::Attributes::Address, nil]
            optional :address,
                     -> {
            ...
            # @!parse
            #   # @param status [String]
            #   # @param address [Unit::Models::Applications::DocumentCreateResponse::Data::Attributes::Address]
