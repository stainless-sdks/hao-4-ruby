  ...
  module Models
    module Applications
      class DocumentMultipartResponse < Unit::BaseModel
        ...
        # @!parse
        #   # @param data [Unit::Models::Applications::DocumentMultipartResponse::Data, nil]
        #   #
        ...
        class Data < Unit::BaseModel
          ...
          #
          #   @return [Unit::Models::Applications::DocumentMultipartResponse::Data::Attributes]
          required :attributes, -> { Unit::Models::Applications::DocumentMultipartResponse::Data::Attributes }

          # @!attribute type
          #
          #   @return [Symbol, Unit::Models::Applications::DocumentMultipartResponse::Data::Type]
          required :type, enum: -> { Unit::Models::Applications::DocumentMultipartResponse::Data::Type }

          # @!parse
          #   # @param id [String]
          #   # @param attributes [Unit::Models::Applications::DocumentMultipartResponse::Data::Attributes]
          #   # @param type [String]
          #   #
          ...
          class Attributes < Unit::BaseModel
            ...
            # @!parse
            #   # @param status [String]
            #   # @param address [Unit::Models::Applications::DocumentMultipartResponse::Data::Attributes::Address, nil]
