  ...
  module Models
    module Applications
      class DocumentVerifyResponse < Unit::BaseModel
        ...
        # @!parse
        #   # @param data [Unit::Models::Applications::DocumentVerifyResponse::Data, nil]
        #   #
        ...
        class Data < Unit::BaseModel
          ...
          class Attributes < Unit::BaseModel
            ...
            # @!parse
            #   # @param status [String]
            #   # @param address [Unit::Models::Applications::DocumentVerifyResponse::Data::Attributes::Address, nil]
