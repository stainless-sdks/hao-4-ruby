  ...
  module Models
    module Applications
      class DocumentListResponse < Unit::BaseModel
        ...
        # @!parse
        #   # @param data [Array<Unit::Models::Applications::DocumentListResponse::Data>, nil]
        #   #
        ...
        class Data < Unit::BaseModel
          ...
          class Attributes < Unit::BaseModel
            ...
            # @!parse
            #   # @param status [String]
            #   # @param address [Unit::Models::Applications::DocumentListResponse::Data::Attributes::Address, nil]
