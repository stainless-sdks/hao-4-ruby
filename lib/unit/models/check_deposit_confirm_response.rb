...
module Unit
  module Models
    ...
    class CheckDepositConfirmResponse < Unit::BaseModel
      # @!attribute [r] data
      #
      #   @return [Unit::Models::CheckDepositConfirmResponse::Data, nil]
      ...
      #   type: Unit::Models::CheckDepositConfirmResponse::Data::Type
      # }
      # ```
      class Data < Unit::BaseModel
        ...
        #   created_at: Time,
        #   description: String,
        #   status: Unit::Models::CheckDepositConfirmResponse::Data::Attributes::Status,
        #   check_number: String,
        #   **_
        # }
        # ```
        class Attributes < Unit::BaseModel
          ...
          #
          #   @return [Unit::Models::CheckDepositConfirmResponse::Data::Attributes::Counterparty, nil]
          ...
          class StatusHistory < Unit::BaseModel
            ...
            # ```ruby
            # status => {
            #   type: Unit::Models::CheckDepositConfirmResponse::Data::Attributes::StatusHistory::Status::Type
            # }
            # ```
            class Status < Unit::BaseModel
              # @!attribute [r] type
              #
              #   @return [Symbol, Unit::Models::CheckDepositConfirmResponse::Data::Attributes::StatusHistory::Status::Type, nil]
              optional :type,
                       enum: -> {
        ...
        class Relationships < Unit::BaseModel
          ...
          #
          #   @return [Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Customer, nil]
          ...
          # @!attribute [r] org
          #
          #   @return [Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Org, nil]
          ...
          #
          #   @return [Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Transaction, nil]
          ...
          class Account < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Account::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
          ...
          class Customer < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Customer::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
          ...
          class Transaction < Unit::BaseModel
            ...
            # data => {
            #   id: String,
            #   type: Unit::Models::CheckDepositConfirmResponse::Data::Relationships::Transaction::Data::Type
            # }
            # ```
            class Data < Unit::BaseModel
              # @!attribute id
