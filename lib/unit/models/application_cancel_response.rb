...
module Unit
  module Models
    class ApplicationCancelResponse < Unit::BaseModel
      ...
      #   # @param included [Array<Unit::Models::ApplicationCancelResponse::Included>, nil]
      #   #
      ...
      class Included < Unit::BaseModel
        ...
        class Attributes < Unit::BaseModel
          ...
          # @!parse
          #   # @param status [String]
          #   # @param address [Unit::Models::ApplicationCancelResponse::Included::Attributes::Address, nil]
