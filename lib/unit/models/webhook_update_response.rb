...
module Unit
  module Models
    ...
    class WebhookUpdateResponse < Unit::BaseModel
      # @!attribute [r] data
      #
      #   @return [Unit::Models::WebhookUpdateResponse::Data, nil]
      ...
      #   type: enum: Unit::Models::WebhookUpdateResponse::Data::Type
      # }
      # ```
      class Data < Unit::BaseModel
        ...
        # attributes => {
        #   token: String,
        #   content_type: enum: Unit::Models::WebhookUpdateResponse::Data::Attributes::ContentType,
        #   created_at: Time,
        #   delivery_mode: enum: Unit::Models::WebhookUpdateResponse::Data::Attributes::DeliveryMode,
        #   label: String,
        #   **_
        # }
        # ```
        class Attributes < Unit::BaseModel
          ...
          #
          #   @return [Symbol, Unit::Models::WebhookUpdateResponse::Data::Attributes::ContentType, nil]
          ...
          #
          #   @return [Symbol, Unit::Models::WebhookUpdateResponse::Data::Attributes::DeliveryMode, nil]
